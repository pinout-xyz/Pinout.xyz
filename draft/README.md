...
A long description is also highly desirable so that visitors to the site can get an introduction to the add-on boards featured on the site if they are not familiar with them.
...
I2C and SPI pins should be included if your board uses them, however they will generally be interpreted as being shared and usable with multiple boards unless you explicitly define them as being an input or output.
